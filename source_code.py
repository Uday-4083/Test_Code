...
def retrieve_password_handler()
    ...
    if stored_password
        ...
        messagebox.showinfo(Password, fRetrieved password for '{account}' and username '{username}' '{decrypted_password}')
    else
        messagebox.showerror(Error, fNo password found for '{account}' and username '{username}')
